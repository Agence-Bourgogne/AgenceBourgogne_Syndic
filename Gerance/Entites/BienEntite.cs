...
namespace GeranceData.Entites
{
    public class BienEntite : AbstractBaseEntite
    {
        ...
        public decimal MontantDu
        {
            get
            {
                return montant_loyer + frais_bail + montant_charges + valeur_taxe + montant_augmentation + montant_divers1 + montant_divers2 + montant_divers3 + montant_divers4 + montant_divers5;
            }
